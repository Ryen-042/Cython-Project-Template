...
cdef class IsPrimeNamespace:
    """The only purpose of this class is to enable other c extensions to import the cdef methods in this module."""

    @cython.boundscheck(False)
    @cython.wraparound(False)
    @cython.cdivision(True)
    @staticmethod
    cdef public inline bint isPrime(int num) noexcept nogil:
